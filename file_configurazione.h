...
//dichiaro la struct esterna in modo tale da dichiare la variabile senza definirla
...
extern void Esegui_come_medico(MYSQL *conn);
extern void Esegui_come_amministratore(MYSQL *conn);
